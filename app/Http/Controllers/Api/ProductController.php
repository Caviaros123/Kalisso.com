...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('image') && auth('api')->user()) {
            ...
            $storeData = Profile::where('email', auth('api')->user()->email)->first();
        ...
        if ($validator->fails()) {
            ...
            try {
                \DB::table('tbl_review')->insert([
                    ...
                    'review_name' => auth('api')->user()->name,
                    'user_id' => auth('api')->id(),
                ...
                $data = \DB::table('tbl_review')->where('user_id', auth('api')->id())->latest()->take(1)->get();
