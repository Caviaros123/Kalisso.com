  ...
  <div>
    <section class="section-content padding-y-xs" style="min-height: 16vh">
      ...
      <div class="card mx-auto" style="max-width: 520px; margin-top: 10px">
        ...
        <div v-if="serverErrors" class="alert alert-danger text-center m-2">
          {{ serverErrors }}
        </div>
        ...
        <article class="card-body">
          ...
          <form action="#" method="POST" @submit.prevent="validateBeforeSubmit">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                >
                  ...
                  <option data-countrycode="CG" value="242" selected="selected">
                    Congo (+242)
                  </option>
            ...
            <div class="form-group">
              <button type="submit" @click="validateBeforeSubmit()" class="btn btn-primary btn-block">
                Inscription
              </button>
            </div>
